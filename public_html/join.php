...
<body>
  ...
  <div class="row" style="padding-top: 50px; padding-bottom: 40px;">
    ...
    <div class="col-md-10">
      ...
      <div class="col-md-6">
        <h1 style="color:#1a75ff;">Join Enactus at the University of Virginia</h1>
        <span class="byline"><p class="yellow">Enactus sponsors love to hire Enactus students.</p></span>
        <p>
